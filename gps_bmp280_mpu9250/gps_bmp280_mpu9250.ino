...
//ERROR MILLIS DECLARATION
const int ledPin = 13;
int ledState = LOW;
unsigned long errorBlinkMillis = 0;
const long errorBlinkInterval = 100;
int isError = 0;
...
void dataPreparation() {
  ...
  pressureBMP = (pressure_event.pressure);
...
void sendSerialData() {
  ...
  if (gps.hdop.value() == 9999) {
    internalSerial.println("===================================================================");
    internalSerial.println("                       GPS SIGNAL LOST");
    internalSerial.println("===================================================================");
  }
  else if (gps.hdop.value() < 9999) {
    internalSerial.println("===================================================================");
    internalSerial.print("SIGNAL = ");
    for (int i; i < gps.satellites.value(); i++) {
      Serial.print("*");
    }
    internalSerial.println();
    internalSerial.println("===================================================================");
  ...
  internalSerial.print("Air Pressure BMP280 = ");
  internalSerial.print(pressureBMP);
  internalSerial.println(" hPa");
  internalSerial.print("Altitude BMP280     = ");
